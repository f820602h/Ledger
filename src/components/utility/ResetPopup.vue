      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <button type="button" class="close" @click="toggleResetPopup(false)">
              <span>&times;</span>
            </button>
          </div>
            ...
            <form>
              <div class="input-group mt-4">
                ...
                <input
                  ...
                  class="form-control"
                  id="cost"
                  v-model.trim="$v.newSave.$model"
                  @blur="$v.newSave.$touch"
                />
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" @click="toggleResetPopup(false)">
              取消
            </button>
